    ...
    for line in f.readlines():
        ...
        try:
            ...
            with open("/home/bbian/Data_all_calibrate/result/partial_test/"+input_path+"/{}.txt".format(geneid), "r") as f:
                ...
                a1 = a.dropna()
                data1= pg.partial_corr(data=a1, x='ReadsCount', y='idr', covar=['RelativeASA', 'codon_usage', 'normalized_CO', 'relative_CO','absolute_CO'],method = 'spearman').round(3)
                shel= data1.iat[0, 1]
            ...
            print(daf, file=open("/home/bbian/Data_all_calibrate/result/partial_test/spearman_partial/"+input_path+".partial.single_gene_corre_idr.txt", "a"))
        except IOError:
            continue
