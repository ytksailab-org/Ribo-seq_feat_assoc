    ...
    for line in f.readlines():
        ...
        with open(my_file, "r") as t:
            ...
            for i in range(len(reads_counts)):
                ...
                if charges[i] == "1" and index1 > 0 and index2 < len(reads_counts):
...
plt.plot(label, mean_values, color='blue', label='Mean')
plt.fill_between(label, lower_ci, upper_ci, color='blue', alpha=0.2, label='95% CI')
plt.xlabel('Position')
